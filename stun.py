...
│                  ██║ ╚████║██║  ██║███████╗██║ ╚████║███████╗███████║██║██║  ██║                   │
│                  ╚═╝  ╚═══╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═══╝╚══════╝╚══════╝╚═╝╚═╝  ╚═╝                   │
│                                                                                Follow gh NazrilOfficial1     │
└────────────────────────────────────────────────────────────────────────────────────────────────────┘
	cetak(panel(f"""[bold green]                ___  ____ ____ _   _ ____ _  _ _  _ _  _ 
[bold green]                WELCOME TO MY RECODE SC 
[bold green]                NAZRILOFFICIAL                                                                                                        
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]Alvino_Xy , Brayennn XD , Asepit-Gans , Rozhak XD , Dapunta , Nazri XD And AOREC XD",width=90,title=f"[bold green]Thanks To",padding=(0,5),style=f"bold white"))
